...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '51475a24509b82aab583010f7168e756',
  THEME: process.env.NEXT_PUBLIC_THEME || 'endspace-me', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'augustsu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.auguspage.cc', // 网站地址
